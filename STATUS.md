...
## 2026-07-01 Update - Auth gate foundation for sensitive endpoints

**Status:** in progress.

- Started P0-3 from `docs/健檢修復排程-2026-07-01.md`.
...
- Added Supabase adapter support for runtime credits tables: `credit_wallets`, `credit_transactions`, and `credit_ledger`.
